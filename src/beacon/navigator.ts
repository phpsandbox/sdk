...
export class Navigator implements NavigatorActions {
  ...
  constructor(
    ...
    private onceEvent: <K extends keyof NavigatorEvents>(event: K, handler: (payload: NavigatorEvents[K]) => void) => Disposable,
   ...
   */
  once<K extends keyof NavigatorEvents>(event: K, handler: (payload: NavigatorEvents[K]) => void): Disposable {
